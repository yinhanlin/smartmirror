  ...
  , Dropzone = function() {
    ...
    _createClass(b, [{
        ...
        value: function() {
            ...
            this.clickableElements.length && function r() {
        ...
        value: function(e, t, n) {
            if (void 0 !== n) {
                ...
                e[0].upload.chunked) {
                    ...
                    i.upload.progress = 0,
                    i.upload.total = 0;
                    for (var o = i.upload.bytesSent = 0; o < i.upload.totalChunkCount; o++)
                        void 0 !== i.upload.chunks[o] && void 0 !== i.upload.chunks[o].progress && (i.upload.progress += i.upload.chunks[o].progress,
                    ...
                    var a, l = _createForOfIteratorHelper(e);
                    try {
                        for (l.s(); !(a = l.n()).done; ) {
                            var s = a.value;
                            s.upload.progress = f,
                ...
                var u, c = _createForOfIteratorHelper(e);
                try {
                    for (c.s(); !(u = c.n()).done; ) {
                        var d = u.value;
                ...
                var p, h = !0, f = 100, m = _createForOfIteratorHelper(e);
                try {
                    for (m.s(); !(p = m.n()).done; ) {
                        var v = p.value;
...
Dropzone.discover = function() {
    var o, e;
    return document.querySelectorAll ? o = document.querySelectorAll(".dropzone") : (o = [],
    (e = function(r) {
        return function() {
